...
<template>
  <div>
    ...
    <div class="social-media">
      <a href="https://www.facebook.com/leonelmenci" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          style="fill: #3b5998; transform: ; msfilter: "
        >
          <path
      ...
      <a href="https://www.instagram.com/leo_skateboard/" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          style="fill: #f09433; transform: ; msfilter: "
        >
          <path
      ...
      <a href="https://www.linkedin.com/in/leonel-menci/" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          style="fill: #0077b5; transform: ; msfilter: "
        >
          <path
